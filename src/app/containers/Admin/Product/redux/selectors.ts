...
const getProductsPagination = (state: RootState): TPagination => state.admin_products.pagination;
const getProducts = (state: RootState): TPagination => state.admin_products.products;
const getProduct = (state: RootState) => state.admin_products.productDetail;
